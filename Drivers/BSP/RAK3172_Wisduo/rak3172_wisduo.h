/*
 * rakwireless_wisduo.h
 *
 *  Created on: Mar 18, 2022
 *      Author: Dana H. Myers
 */

#ifndef RAK3172_WISDUO_H
#define RAK3172_WISDUO_H
...
/* Includes ------------------------------------------------------------------*/
#include "rak3172_wisduo_errno.h"
#include "rak3172_wisduo_conf.h"
...
/** @defgroup RAK3172_WISDUO RAK3172-WISDUO
  * @{
  */

/** @defgroup RAK3172_WISDUO_LOW_LEVEL LOW LEVEL
  * @{
  */

/** @defgroup RAK3172_WISDUO_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
typedef enum 
{
...
/** @defgroup RAK3172_WISDUO_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  * @{
  */ 

/**
  * @brief RAK3172 WISDUO BSP Driver version number
  */
#define __RAK3172_WISDUO_BSP_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define __RAK3172_WISDUO_BSP_VERSION_SUB1   (0x01U) /*!< [23:16] sub1 version */
#define __RAK3172_WISDUO_BSP_VERSION_SUB2   (0x00U) /*!< [15:8]  sub2 version */
#define __RAK3172_WISDUO_BSP_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define __RAK3172_WISDUO_BSP_VERSION          ((__RAK3172_WISDUO_BSP_VERSION_MAIN << 24)\
                                              |(__RAK3172_WISDUO_BSP_VERSION_SUB1 << 16)\
                                              |(__RAK3172_WISDUO_BSP_VERSION_SUB2 << 8 )\
                                              |(__RAK3172_WISDUO_BSP_VERSION_RC))

/** 
  * @brief Define for RAK3172_WISDUO board
  */ 
#if !defined (USE_RAK3172_WISDUO)
 #define USE_RAK3172_WISDUO
#endif

/** @defgroup RAK3172_WISDUO_LOW_LEVEL_LED LOW LEVEL LED Constants
  * @{
  */
#define LEDn                                    3
...
/** @defgroup RAK3172_WISDUO_LOW_LEVEL_BUTTON LOW LEVEL BUTTON Constants
  * @{
  */  
#define BUTTONn                                 3
...
#if (USE_BSP_COM_FEATURE > 0)
/** @defgroup RAK3172_WISDUO_LOW_LEVEL_COM LOW LEVEL COM Port Constants
  * @{
  */  
...
/** @addtogroup RAK3172_WISDUO_LOW_LEVEL_Exported_Variables
  * @{
  */
...
/** @defgroup RAK3172_WISDUO_LOW_LEVEL_Exported_Functions LOW LEVEL Exported Functions
  * @{
  */
uint32_t         BSP_GetVersion(void);

/** @defgroup RAK3172_WISDUO_LOW_LEVEL_LED_Functions LOW LEVEL LED Functions
  * @{
  */
...
/** @defgroup RAK3172_WISDUO_LOW_LEVEL_BUTTON_Functions  LOW LEVEL BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE > 0)
/** @defgroup RAK3172_WISDUO_LOW_LEVEL_COM_Functions LOW LEVEL COM Port Functions
  * @{
  */  
