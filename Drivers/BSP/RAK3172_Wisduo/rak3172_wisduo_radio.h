/**
  ******************************************************************************
  * @file    rakwireless_wisduo_radio.h
  * @author  MCD Application Team
  * @brief   Header for rakwireless_wisduo_radio.c
  ******************************************************************************
  * @attention
  *
...
#ifndef RAK3172_WISDUO_RADIO_H
#define RAK3172_WISDUO_RADIO_H
...
/** @addtogroup RAK3172_WISDUO RAK3172-WISDUO
  * @{
  */

/** @defgroup RAK3172_WISDUO_RADIO_LOW_LEVEL RADIO LOW LEVEL
  * @{
  */

/** @defgroup RAK3172_WISDUO_RADIO_LOW_LEVEL_Exported_Types RADIO LOW LEVEL Exported Types
  * @{
  */
...
/** @defgroup RAK3172_WISDUO_RADIO_LOW_LEVEL_Exported_Constants RADIO LOW LEVEL Exported Constants
  * @{
  */

/** @defgroup RAK3172_WISDUO_RADIO_LOW_LEVEL_RADIOCONFIG RADIO LOW LEVEL RADIO CONFIG Constants
  * @{
  */
...
/** @defgroup RAK3172_WISDUO_RADIO_LOW_LEVEL_RFSWITCH RADIO LOW LEVEL RF SWITCH Constants
  * @{
  */
...
/** @defgroup RAK3172_WISDUO_RADIO_LOW_LEVEL_Exported_Functions RADIO LOW LEVEL Exported Functions
  * @{
  */
